...
<p align="center">
  多平台 AI 封面生成器 | 微信公众号 & 小红书 & 今日头条 | Gemini 3 Flash 驱动
</p>
...
- **🎨 多平台模式切换** — 针对不同平台进行尺寸与视觉逻辑优化：
    - **公众号模式 (2.35:1)**：极简、深色、强调效率与专业感。
    - **小红书模式 (3:4)**：高饱和、大字报、强调情绪与点击欲。
    - **今日头条模式 (16:9)**：高对比度、大图清晰、针对今日头条信息流优化，强调资讯热点与第一眼吸睛率。
...
| 模式 | 微信公众号 (WeChat) | 小红书 (Xiaohongshu) | 今日头条 (Toutiao) |
|------|-------------------|-------------------|-------------------|
| **比例** | 2.35 : 1 (横屏) | 3 : 4 (竖屏) | 16 : 9 (横屏) |
| **风格** | 极简、商务、极客 | 杂志感、高饱和、标题党 | 资讯流新闻感、高对比度、吸睛 |
| **布局** | 左文右图，留白呼吸感 | 上下结构，大字报冲击力 | 醒目标签+超大字标题+右侧立体Emoji |
| **适用** | 技术文章、深度观点、干货 | 生活方式、种草、经验分享 | 资讯热点、时事分析、知识科普、深度社科 |
| **核心逻辑** | `降噪`：提炼 4-8 字核心词 | `爆款`：制造情绪与视觉张力 | `醒目`：色块分明、内容主题高度提炼 |
